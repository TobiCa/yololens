...
The brick and template scripts work in a similar ways. They both make sure that the generated objects do not rotate and do snap to a grid. An one-by-one brick is 0.8cm long and wide and 0.96cm high (with know). Thus bricks are forced to lay in position, which is a multiple of 0.8.