...
\\
Since we wanted to test whether or not the HoloLens was too much of a overwhelming experience for the user, the tests were structured so as to minimize any complications with the application itself.\\
